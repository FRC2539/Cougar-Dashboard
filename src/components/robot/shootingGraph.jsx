...
export default class ShootingGraph extends Component {
  ...
  render() {
    ...
    if (Object.keys(this.value).length == 0) {
      body = (
        <div className="w-full h-full animate-pulse flex justify-center space-x-1">
          <div className="flex-auto bg-gray w-5 h-5"></div>
          <div className="flex-auto bg-gray w-5 h-5"></div>
    ...
    return <div className="col-span-1 p-2 flex flex-row h-max">{body}</div>;
  }
}
